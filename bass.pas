...
const
  ...
  // automatically free the music when it stop/ends
  BASS_MUSIC_DECODE  = BASS_STREAM_DECODE;
  // don't play the music, only decode (BASS_ChannelGetData)
...
type
  ...
  TBASS_PLUGINFORMS = array[0..maxInt div sizeOf(BASS_PLUGINFORM) - 1] of
    BASS_PLUGINFORM;
...
function BASS_PluginLoad(filename: PChar; flags: DWORD): HPLUGIN;
  stdcall; external bassdll;
...
function BASS_MusicLoad(mem: BOOL; f: Pointer;
  offset, length, flags, freq: DWORD): HMUSIC; stdcall; external bassdll;
function BASS_MusicFree(handle: HMUSIC): BOOL; stdcall; external bassdll;
function BASS_MusicSetAttribute(handle: HMUSIC; attrib, Value: DWORD): DWORD;
  stdcall; external bassdll;
function BASS_MusicGetAttribute(handle: HMUSIC; attrib: DWORD): DWORD;
  stdcall; external bassdll;
...
function BASS_SampleLoad(mem: BOOL; f: Pointer;
  offset, length, max, flags: DWORD): HSAMPLE; stdcall; external bassdll;
function BASS_SampleCreate(length, freq, chans, max, flags: DWORD): Pointer;
  stdcall; external bassdll;
...
function BASS_StreamCreate(freq, chans, flags: DWORD; proc: Pointer;
  user: DWORD): HSTREAM; stdcall; external bassdll;
function BASS_StreamCreateFile(mem: BOOL; f: Pointer;
  offset, length, flags: DWORD): HSTREAM; stdcall; external bassdll;
function BASS_StreamCreateURL(url: PChar; offset: DWORD; flags: DWORD;
  proc: DOWNLOADPROC; user: DWORD): HSTREAM; stdcall; external bassdll;
function BASS_StreamCreateFileUser(buffered: BOOL; flags: DWORD;
  proc: STREAMFILEPROC; user: DWORD): HSTREAM; stdcall; external bassdll;
function BASS_StreamFree(handle: HSTREAM): BOOL; stdcall; external bassdll;
function BASS_StreamGetFilePosition(handle: HSTREAM; mode: DWORD): DWORD;
  stdcall; external bassdll;
...
function BASS_RecordStart(freq, chans, flags: DWORD; proc: RECORDPROC;
  user: DWORD): HRECORD; stdcall; external bassdll;

function BASS_ChannelBytes2Seconds(handle: DWORD; pos: QWORD): FLOAT;
  stdcall; external bassdll;
function BASS_ChannelSeconds2Bytes(handle: DWORD; pos: FLOAT): QWORD;
  stdcall; external bassdll;
...
function BASS_ChannelGetInfo(handle: DWORD; var info: BASS_CHANNELINFO): BOOL;
  stdcall; external bassdll;
function BASS_ChannelGetTags(handle: HSTREAM; tags: DWORD): PChar;
  stdcall; external bassdll;
...
function BASS_ChannelSetAttributes(handle: DWORD; freq, volume, pan: integer): BOOL;
  stdcall; external bassdll;
function BASS_ChannelGetAttributes(handle: DWORD; var freq, volume: DWORD;
  var pan: integer): BOOL; stdcall; external bassdll;
function BASS_ChannelSlideAttributes(handle: DWORD; freq, volume, pan: integer;
  time: DWORD): BOOL; stdcall; external bassdll;
function BASS_ChannelIsSliding(handle: DWORD): DWORD; stdcall; external bassdll;
function BASS_ChannelSet3DAttributes(handle: DWORD; mode: integer;
  min, max: FLOAT; iangle, oangle, outvol: integer): BOOL; stdcall; external bassdll;
function BASS_ChannelGet3DAttributes(handle: DWORD; var mode: DWORD;
  var min, max: FLOAT; var iangle, oangle, outvol: DWORD): BOOL; stdcall;
  external bassdll;
function BASS_ChannelSet3DPosition(handle: DWORD;
  var pos, orient, vel: BASS_3DVECTOR): BOOL; stdcall; external bassdll;
function BASS_ChannelGet3DPosition(handle: DWORD;
  var pos, orient, vel: BASS_3DVECTOR): BOOL; stdcall; external bassdll;
function BASS_ChannelGetLength(handle: DWORD): QWORD; stdcall; external bassdll;
function BASS_ChannelSetPosition(handle: DWORD; pos: QWORD): BOOL;
  stdcall; external bassdll;
...
function BASS_ChannelGetData(handle: DWORD; buffer: Pointer; length: DWORD): DWORD;
  stdcall; external bassdll;
function BASS_ChannelSetSync(handle: DWORD; stype: DWORD; param: QWORD;
  proc: SYNCPROC; user: DWORD): HSYNC; stdcall; external bassdll;
function BASS_ChannelRemoveSync(handle: DWORD; sync: HSYNC): BOOL;
  stdcall; external bassdll;
function BASS_ChannelSetDSP(handle: DWORD; proc: DSPPROC; user: DWORD;
  priority: integer): HDSP; stdcall; external bassdll;
function BASS_ChannelRemoveDSP(handle: DWORD; dsp: HDSP): BOOL; stdcall;
  external bassdll;
function BASS_ChannelSetEAXMix(handle: DWORD; mix: FLOAT): BOOL;
  stdcall; external bassdll;
function BASS_ChannelGetEAXMix(handle: DWORD; var mix: FLOAT): BOOL;
  stdcall; external bassdll;
...
function BASS_ChannelSetFX(handle, etype: DWORD; priority: integer): HFX;
  stdcall; external bassdll;
function BASS_ChannelRemoveFX(handle: DWORD; fx: HFX): BOOL; stdcall; external bassdll;

function BASS_FXSetParameters(handle: HFX; par: Pointer): BOOL; stdcall;
  external bassdll;
function BASS_FXGetParameters(handle: HFX; par: Pointer): BOOL; stdcall;
  external bassdll;
...
begin
  case (env) of
    ...
    EAX_ENVIRONMENT_CARPETEDHALLWAY:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_CARPETEDHALLWAY,
        0.153, 0.259, 2.0);
    EAX_ENVIRONMENT_HALLWAY:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_HALLWAY, 0.361, 1.493, 0);
    EAX_ENVIRONMENT_STONECORRIDOR:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_STONECORRIDOR,
        0.444, 2.697, 0.638);
